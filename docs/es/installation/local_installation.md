...
Antes de comenzar a instalar Moucharaka Mouwatina, comprueba que tengas todos los [prerrequisitos](prerequisites.md) correctamente instalados.

1. Primero, clona el [repositorio de Moucharaka Mouwatina en Github](https://github.com/consuldemocracy/consuldemocracy/) y ve a la carpeta del proyecto:
...
¡Felicidades! Tu aplicación Moucharaka Mouwatina local estará corriendo en `http://localhost:3000`.
